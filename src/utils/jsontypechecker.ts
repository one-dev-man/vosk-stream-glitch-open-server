...
export class JsonTypeChecker {
    ...
    static TYPE_CONSTRUCTORS = {
        ...
        "object"    : (...args: Array<any>) => { return eval("Object("+args.join(",")+");"); },
        ...
        "string"    : (...args: Array<any>) => { return eval("String("+args.join(",")+");"); },
        ...
        "number"    : (...args: Array<any>) => { return eval("Number("+args.join(",")+");"); },
